...
bool UNIT_TEST_inventory::inventory12()
{
    string name = "inventory12";
    //! data ------------------------------------
...
Index is invalid!\n";
    ...
    try
    {
        output<< inventory.getProductQuantity(2)<<endl;
    }
    ...
    try
    {
        output<< inventory.getProductQuantity(4)<<endl;
    }
    catch(const std::exception& e)
    {
        output << e.what() << '\n';
    ...
    try
    {
        output<< inventory.getProductQuantity(-1)<<endl;
    }
    catch(const std::exception& e)
    {
        output << e.what() << '\n';

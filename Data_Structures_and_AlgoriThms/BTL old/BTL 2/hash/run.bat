...
set BUILD_CMD=g++ -std=c++17 -o main -Iinclude -Itest -Itest\unit_test_hash main.cpp ^
test\unit_test_hash\unit_test_hash.cpp test\unit_test.cpp ^
src\Point.cpp src\sampleFunc.cpp src\hash.cpp 


for %%F in (test\unit_test_hash\test_case\*.cpp) do (

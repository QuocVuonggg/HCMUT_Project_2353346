...
stringstream output;
output << "table size: " << map.getCapacity() << endl;
output << "current count: " << map.size() << endl;
output << "real load factor: " << (float) map.size() / map.getCapacity() << endl;
output << "max #collisions: " << max << endl;

  string country = "Vietnam";
  output << "Capital of " << country << " is " << map.get("Vietnam") << endl;
    string expect ="table size: 366\n\
current count: 247\n\

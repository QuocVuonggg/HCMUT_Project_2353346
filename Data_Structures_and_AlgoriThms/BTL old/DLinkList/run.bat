...
set BUILD_CMD=g++ -std=c++17 -o main -Iinclude -Itest -Itest\unit_test_DLinkedList main.cpp ^
test\unit_test_DLinkedList\unit_test_DLinkedList.cpp test\unit_test.cpp ^
src\Point.cpp src\DLinkedList.cpp


for %%F in (test\unit_test_DLinkedList\test_case\*.cpp) do (

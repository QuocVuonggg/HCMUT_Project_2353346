...
BUILD_CMD="g++ -fsanitize=address -std=c++17 -o main -Iinclude -Itest -Itest/unit_test_DLinkedList -g main.cpp \
test/unit_test_DLinkedList/unit_test_DLinkedList.cpp test/unit_test.cpp \
src/DLinkedList.cpp src/Point.cpp test/unit_test_DLinkedList/test_case/*.cpp"
